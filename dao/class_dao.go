...
type ClassDAO interface {
	...
	GetClassByCode(classCode string) (*model.Class, error)
	UpdateClass(classId string, updates map[string]interface{}) error
	DeleteClass(classId string) error
	ListClasses(whereClause string, args []interface{}, limit, offset int32) ([]*model.Class, error)
	CountClasses(whereClause string, args []interface{}) (int32, error)
	ListClassesByTeacherId(teacherId string, limit, offset int32) ([]*model.Class, error)
}
...
// CreateClass 创建班级
func (d *classDAOImpl) CreateClass(class *model.Class) error {
	db := client.GetMySQLClient().GormDB
	return db.Create(class).Error
}

// GetClassById 根据班级ID查询班级
func (d *classDAOImpl) GetClassById(classId string) (*model.Class, error) {
	db := client.GetMySQLClient().GormDB
...
func (d *classDAOImpl) GetClassByCode(classCode string) (*model.Class, error) {
	db := client.GetMySQLClient().GormDB
	var class model.Class
...
func (d *classDAOImpl) UpdateClass(classId string, updates map[string]interface{}) error {
	db := client.GetMySQLClient().GormDB
	return db.Model(&model.Class{}).Where("class_id = ?", classId).Updates(updates).Error
}

// DeleteClass 删除班级
func (d *classDAOImpl) DeleteClass(classId string) error {
	db := client.GetMySQLClient().GormDB
	return db.Where("class_id = ?", classId).Delete(&model.Class{}).Error
}

// ListClasses 查询班级列表
func (d *classDAOImpl) ListClasses(whereClause string, args []interface{}, limit, offset int32) ([]*model.Class, error) {
	db := client.GetMySQLClient().GormDB
	var classes []*model.Class
	query := db.Model(&model.Class{})
...
func (d *classDAOImpl) ListClassesByTeacherId(teacherId string, limit, offset int32) ([]*model.Class, error) {
	db := client.GetMySQLClient().GormDB
	var classes []*model.Class
...
type ClassMemberDAO interface {
	AddMember(member *model.ClassMember) error
	RemoveMember(classId, studentId string) error
	GetMember(classId, studentId string) (*model.ClassMember, error)
	ListMembersByClassId(classId string, limit, offset int32) ([]*model.ClassMember, error)
	ListClassesByStudentId(studentId string, limit, offset int32) ([]*model.ClassMember, error)
...
// AddMember 添加班级成员
func (d *classMemberDAOImpl) AddMember(member *model.ClassMember) error {
	db := client.GetMySQLClient().GormDB
...
func (d *classMemberDAOImpl) RemoveMember(classId, studentId string) error {
	db := client.GetMySQLClient().GormDB
	return db.Where("class_id = ? AND student_id = ?", classId, studentId).Delete(&model.ClassMember{}).Error
}

// GetMember 查询班级成员
func (d *classMemberDAOImpl) GetMember(classId, studentId string) (*model.ClassMember, error) {
	db := client.GetMySQLClient().GormDB
...
func (d *classMemberDAOImpl) ListMembersByClassId(classId string, limit, offset int32) ([]*model.ClassMember, error) {
	db := client.GetMySQLClient().GormDB
...
func (d *classMemberDAOImpl) ListClassesByStudentId(studentId string, limit, offset int32) ([]*model.ClassMember, error) {
	db := client.GetMySQLClient().GormDB
	var members []*model.ClassMember
...
func (d *classMemberDAOImpl) CountMembersByClassId(classId string) (int32, error) {
	db := client.GetMySQLClient().GormDB
	var count int64
	err := db.Model(&model.ClassMember{}).Where("class_id = ? AND status = 1", classId).Count(&count).Error
	return int32(count), err
}
...
func (d *classMemberDAOImpl) UpdateMemberStatus(classId, studentId string, status int32) error {
	db := client.GetMySQLClient().GormDB
	return db.Model(&model.ClassMember{}).Where("class_id = ? AND student_id = ?", classId, studentId).Update("status", status).Error
}
