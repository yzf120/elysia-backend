...
`model_id`    VARCHAR(100) NOT NULL COMMENT '模型ID（如 doubao-seed-2-0-lite-260215）',
...
('doubao-seed-2-0-lite-260215', 'Doubao-Seed-2.0-lite', 'doubao', '豆包多模态模型，支持深度思考，适合快速响应场景', 1),
