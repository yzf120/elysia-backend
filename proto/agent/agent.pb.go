...
const file_agent_agent_proto_rawDesc = "" +
	"\n" +
	"\x11agent/agent.proto\x12\x19trpc.elysia.backend.agent\"\x81\x01\n" +
	...
	"\n" +
	"parameters\x18\x03 \x03(\v2>.trpc.elysia.backend.agent.ExecuteAgentRequest.ParametersEntryR\n" +
	"parameters\x1a=\n" +
	...
	"executedAt\x12\x16\n" +
	"\x06status\x18\x05 \x01(\tR\x06status2\xb8\x04\n" +
	"\fAgentService\x12n\n" +
	"\vCreateAgent\x12-.trpc.elysia.backend.agent.CreateAgentRequest\x1a..trpc.elysia.backend.agent.CreateAgentResponse\"\x00\x12e\n" +
	"\bGetAgent\x12*.trpc.elysia.backend.agent.GetAgentRequest\x1a+.trpc.elysia.backend.agent.GetAgentResponse\"\x00\x12n\n" +
	"\vUpdateAgent\x12-.trpc.elysia.backend.agent.UpdateAgentRequest\x1a..trpc.elysia.backend.agent.UpdateAgentResponse\"\x00\x12n\n" +
	"\vDeleteAgent\x12-.trpc.elysia.backend.agent.DeleteAgentRequest\x1a..trpc.elysia.backend.agent.DeleteAgentResponse\"\x00\x12q\n" +
	"\fExecuteAgent\x12..trpc.elysia.backend.agent.ExecuteAgentRequest\x1a/.trpc.elysia.backend.agent.ExecuteAgentResponse\"\x00B.Z,github.com/yzf120/elysia-backend/proto/agentb\x06proto3"
...
var file_agent_agent_proto_goTypes = []any{
	(*CreateAgentRequest)(nil),   // 0: trpc.elysia.backend.agent.CreateAgentRequest
	(*CreateAgentResponse)(nil),  // 1: trpc.elysia.backend.agent.CreateAgentResponse
	(*GetAgentRequest)(nil),      // 2: trpc.elysia.backend.agent.GetAgentRequest
	(*GetAgentResponse)(nil),     // 3: trpc.elysia.backend.agent.GetAgentResponse
	(*UpdateAgentRequest)(nil),   // 4: trpc.elysia.backend.agent.UpdateAgentRequest
	(*UpdateAgentResponse)(nil),  // 5: trpc.elysia.backend.agent.UpdateAgentResponse
	(*DeleteAgentRequest)(nil),   // 6: trpc.elysia.backend.agent.DeleteAgentRequest
	(*DeleteAgentResponse)(nil),  // 7: trpc.elysia.backend.agent.DeleteAgentResponse
	(*ExecuteAgentRequest)(nil),  // 8: trpc.elysia.backend.agent.ExecuteAgentRequest
	(*ExecuteAgentResponse)(nil), // 9: trpc.elysia.backend.agent.ExecuteAgentResponse
	nil,                          // 10: trpc.elysia.backend.agent.ExecuteAgentRequest.ParametersEntry
}
var file_agent_agent_proto_depIdxs = []int32{
	10, // 0: trpc.elysia.backend.agent.ExecuteAgentRequest.parameters:type_name -> trpc.elysia.backend.agent.ExecuteAgentRequest.ParametersEntry
	0,  // 1: trpc.elysia.backend.agent.AgentService.CreateAgent:input_type -> trpc.elysia.backend.agent.CreateAgentRequest
	2,  // 2: trpc.elysia.backend.agent.AgentService.GetAgent:input_type -> trpc.elysia.backend.agent.GetAgentRequest
	4,  // 3: trpc.elysia.backend.agent.AgentService.UpdateAgent:input_type -> trpc.elysia.backend.agent.UpdateAgentRequest
	6,  // 4: trpc.elysia.backend.agent.AgentService.DeleteAgent:input_type -> trpc.elysia.backend.agent.DeleteAgentRequest
	8,  // 5: trpc.elysia.backend.agent.AgentService.ExecuteAgent:input_type -> trpc.elysia.backend.agent.ExecuteAgentRequest
	1,  // 6: trpc.elysia.backend.agent.AgentService.CreateAgent:output_type -> trpc.elysia.backend.agent.CreateAgentResponse
	3,  // 7: trpc.elysia.backend.agent.AgentService.GetAgent:output_type -> trpc.elysia.backend.agent.GetAgentResponse
	5,  // 8: trpc.elysia.backend.agent.AgentService.UpdateAgent:output_type -> trpc.elysia.backend.agent.UpdateAgentResponse
	7,  // 9: trpc.elysia.backend.agent.AgentService.DeleteAgent:output_type -> trpc.elysia.backend.agent.DeleteAgentResponse
	9,  // 10: trpc.elysia.backend.agent.AgentService.ExecuteAgent:output_type -> trpc.elysia.backend.agent.ExecuteAgentResponse
